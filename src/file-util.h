...
class FileUtil {
    public:
         ...
         * and returns the two newly-allocated file descriptors in a vector.
         * The pipe is configured with O_CLOEXEC so it will be automatically closed when execve() is called.
         *
         * @throw Throws a FileException if the pipe cannot be created or configured correctly.
         *
         ...
         *
         * @throw Throws a FileException if the file cannnot be closed for any reason.
         *
        ...
        /**
         * Creates a copy of the file descriptor old_fd, using the descriptor number specified in new_fd.
         * If the file descriptor new_fd was previously open,
         * it is silently closed before being reused. After a successful return,
         * the old and new file descriptors may be used interchangeably.
         * They literally refer to the same open file description.
         *
         * @throw Throws a FileException if the file descriptor cannot be duplicated.
         *
        ...
        /**
         * Reads the complete contents of the given file descriptor fd
         ...
         * a small, nonnegative integer that is used in subsequent system calls to refer to the open file.
         * The file descriptor returned by a successful call will be the lowest-numbered file descriptor
         * not currently open for the process.
         *
         * Optionally, flags and a mode can be specified which change the behavior of the opened file, e.g.
         * opening it for reading vs. writing or setting the permissions on a newly-created file.
         * See the standard C documentation for open() to learn more about these options.
         *
         * @throw Throws a FileException if the file cannot be opened.
         *
         ...
         */
        static int OpenFile(string& file_path, int flags = O_RDONLY, mode_t mode = S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH);

        /**
         * Return a vector of all directory entries in the given directory path.
         * Skips over trivial directory entries like "." and "..".
         *
         * @throw Throws a FileException if the directory cannot be opened or the stream of directory entries cannot be read.
         *
         ...
         * Glob patterns are quite similar to regular expressions but they are not quite the same.
         * The rules for glob matching are too complex to list here, but complete information can be found online from various resources
         * such as http://tldp.org/LDP/abs/html/globbingref.html.
         *
         * The search starts in the current working directory.
         * @throw Throws a FileException if the given pattern is invalid,
         * e.g. it has unclosed character class.
         *
         * Returns a vector of all the files or directories which match the given glob pattern.
         * If no files or directories are matched,
         * then vector containing a single string representing the original pattern is returned.
         *
        ...
        /**
         * Returns true if the given file or directory has the executable permission bit set.
         *
    ...
    private:
         ...
         * the given candidate file or directory name.
         *
